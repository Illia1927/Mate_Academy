...
public class Score {
    ...
    public static int matchResult(int firstTeamScore, int secondTeamScore, int firstRate, int secondRate) {
        return (firstTeamScore == firstRate && secondTeamScore == secondRate) ? 2 : ((firstTeamScore > secondTeamScore && firstRate > secondRate) || (firstTeamScore < secondTeamScore && firstRate < secondRate)) ? 1 : 0;
    }
}
